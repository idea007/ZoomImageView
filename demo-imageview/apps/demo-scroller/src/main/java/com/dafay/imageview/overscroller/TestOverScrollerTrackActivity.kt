...
import com.dafay.imageview.databinding.ActivityTestOverScrollerTrackBinding

class TestOverScrollerTrackActivity : BaseActivity(R.layout.activity_test_over_scroller_track) {
    override val binding: ActivityTestOverScrollerTrackBinding by viewBinding()
