...
import com.dafay.demo.zoom.ui.page.gesture.DEFAULT_ANIM_DURATION
import com.dafay.demo.zoom.ui.page.gesture.DEFAULT_MAX_ZOOM
import com.dafay.demo.zoom.ui.page.gesture.DEFAULT_MID_ZOOM
import com.dafay.demo.zoom.ui.page.gesture.DEFAULT_MIN_ZOOM
import com.dafay.demo.zoom.ui.page.gesture.Edge
...
class Zoom08ImageView @kotlin.jvm.JvmOverloads constructor(
    ...
    inner class MultiGestureDetector : GestureDetector.SimpleOnGestureListener(),
        ...
        override fun onSingleTapConfirmed(e: MotionEvent): Boolean {
            viewTapListener?.onViewTap(this@Zoom08ImageView, e.x, e.y)
            return super.onSingleTapConfirmed(e)
        }

        override fun onLongPress(e: MotionEvent) {
            super.onLongPress(e)
            viewTapListener?.onLongClick(this@Zoom08ImageView)
        }
