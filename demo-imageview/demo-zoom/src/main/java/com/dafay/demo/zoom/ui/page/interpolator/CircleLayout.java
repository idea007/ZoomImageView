...
public class CircleLayout extends ViewGroup {
    ...
    private OnTouthDownListener onTouthDownListener = null;
    ...
    private void initRegion() {
        ...
        ring.arcTo(smallCircle, 359.9f, -359.9f);
        ring.close();
        ringRegion = new Region();
        ringRegion.setPath(ring, globalRegion);
...
//        paint.setColor(getResources().getColor(R.color.c_888888));
    ...
    public void setOnTouthDownListener(OnTouthDownListener onTouthDownListener) {
        this.onTouthDownListener = onTouthDownListener;
    }
